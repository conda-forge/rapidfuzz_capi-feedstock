...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rapidfuzz_capi-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15645&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rapidfuzz_capi-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rapidfuzz_capi` can be installed with:

```
conda install rapidfuzz_capi
```

It is possible to list all of the versions of `rapidfuzz_capi` available on your platform with:
